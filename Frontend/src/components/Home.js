...
//   return (
//     <div className="max-w-4xl mx-auto my-16 p-8 bg-[#FFF9F0] rounded-xl shadow-lg text-center font-sans text-gray-800">
...
//           className="bg-indigo-600 hover:bg-indigo-700 text-white text-lg py-3 px-8 rounded-full transition-colors duration-300"
//         >
//           Create Task
//         </button>
//       ) : (
